...
seven destination sites is closest to their problem, and gets them there. `gaba_excites`
became the seventh on 2026-09-23 and carries the NEW sticker. `draughtsman` became the sixth
...
|---|---|
| [gaba.tonydefazio.com](https://gaba.tonydefazio.com) | gaba_excites — current-clamp excitability simulator: step families, rheobase, F–I, and a movable GABA reversal. **Added 2026-09-23, carries the NEW sticker** |
...
no JavaScript, sets no cookies, and carries no analytics** — **six of the seven destination
...
The page makes claims about the seven projects. Each was checked against the source
repository on 2026-08-25 — the fifth on 2026-08-31, the sixth on 2026-09-02/03, the seventh on
2026-09-23 — not written from memory.
...
- **The seven `Born` stamps.** Each is the destination repository's **first commit**, read from
  `git log --reverse` on 2026-09-03 (gaba_excites on 2026-09-23): gaba_excites `c134eaf` 2026-09-21 · draughtsman `ddc332f` 2026-09-01 · short-course `5a6ffc4`
